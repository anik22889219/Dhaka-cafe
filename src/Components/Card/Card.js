...
const Card = (props) => {
    ...
    return (
        <div className='w-[360px] bg-green-400 flex items-center flex-col justify-around mx-auto p-3  rounded-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 hover:bg-green-600 duration-300  '>
            ...
            <div className='mt-7'>
                <button className='flex justify-around items-center bg-red-400 rounded-3xl px-7 py-2 hover:bg-red-600'>Buy now <span className='ms-1'><img src={arrow} alt="" /></span></button>
            </div>
        </div>
    );
};
