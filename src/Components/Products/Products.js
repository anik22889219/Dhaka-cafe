...
const Products = () => {
  ...
  return (
    <div className="sm:ms-5 grid lg:grid-cols-5 md:grid-cols-3 justify-items-center my-6 ">
      <div className="col-span-1 lg:col-span-4 md:col-span-2">
        ...
        <div className="grid sm:grid-cols-1  lg:grid-cols-3 justify-center gap-5 my-8">
