...
const Category = (props) => {
    ...
    return (
        <div>
            <ul className='grid md:grid-cols-3 gap-5 mt-8 justify-center'>
                <li className='w-[350px] h-[120px] bg-orange-400 items-center flex justify-between px-7 rounded-3xl'>
                ...
                <li className='w-[350px] h-[120px] bg-pink-400 items-center flex justify-between px-7 rounded-3xl'>
                ...
                <li className='w-[350px] h-[120px] bg-blue-400 items-center flex justify-between px-7 rounded-3xl'>
